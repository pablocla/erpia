...
| **Demo pública** | `admin@erp-argentina.com` | ERP demo + Cloud si no hay lista explícita de analistas |
...
| Crea | `Empresa` CUIT `20-00000000-0`, `Usuario` `admin@erp-argentina.com`, rol `administrador` |
