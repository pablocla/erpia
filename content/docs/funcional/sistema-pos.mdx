---
title: "Especificación Sistema POS"
description: "Documento sobre especificación sistema pos."
sidebar_position: 10
tags: ["funcional", "pos", "p0"]
audience: all
layer: 1-config
...
| P3 | **Modo offline con contingencia** | Si se corta internet, se requiere facturar offline sin interrupciones. | Integrado con CAEA offline. Ver la [Guía de Contingencia CAEA](file:///c:/Users/Pablo%20Clavero/Downloads/pos-system-argentina/content/docs/funcional/caea-contingencia) para parametrización y sincronización diferida. |
